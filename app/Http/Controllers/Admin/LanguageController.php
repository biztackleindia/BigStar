...
class LanguageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        BusinessSetting::updateOrInsert(['type' => 'language'], ['value' => $lang_array]);
        DB::table('business_settings')->updateOrInsert(['type' => 'pnc_language'], ['value' => json_encode($codes)]);
    ...
    public function update_status(Request $request)
    {
        ...
        $businessSetting = BusinessSetting::where('type', 'language')->update(['value' => $lang_array]);
    ...
    public function update_default_status(Request $request)
    {
        ...
        BusinessSetting::where('type', 'language')->update(['value' => $lang_array]);
    ...
    public function delete($lang)
    {
        ...
        DB::table('business_settings')->updateOrInsert(['type' => 'pnc_language'], ['value' => json_encode($languages)]);
