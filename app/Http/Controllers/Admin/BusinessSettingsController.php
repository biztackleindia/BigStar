...
class BusinessSettingsController extends Controller
{
    ...
    public function pointsindex()
    {
        ...
        $data = DB::select(DB::raw("SELECT * from points"));
        if (count($data) == 0) {
            ...
            $referral_reward_points =$data[0]->referral_reward_points;
            $product_reward_points =$data[0]->product_reward_points;
            $product_min_amount =$data[0]->product_min_amount;
        }
        return view('admin-views.points.view',compact('referral_reward_points','product_reward_points','product_min_amount'));
    }
    ...
    public function updateInfo(Request $request)
    {
        ...
        DB::table('business_settings')->updateOrInsert(['type' => 'member_settings'], [
            'value' => $request['member_settings']
        ]);
        ...
        DB::table('business_settings')->updateOrInsert(['type' => 'transport_mode'], [
    ...
    public function PointsStore(Request $request){
        ...
        DB::delete(DB::raw("DELETE FROM points"));
        DB::table('points')->insert([
            'referral_reward_points'=>$request->referral_reward_points,
            'product_reward_points'=>$request->product_reward_points,
            'product_min_amount'=>$request->product_min_amount,
