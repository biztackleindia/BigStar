...
$is_online_payment =0 ;
$pin_not_match = session('pin_not_match') ? session('pin_not_match') : 0;

if($pincode){
    $is_cash_on_delivery= $pincode[0]->is_cash_on_delivery;
    $is_online_payment = $pincode[0]->is_online_payment;

}
// dd($is_online_payment);
?>
                                ...
                                <div class="card">
                                    <div class="card-body" style="height: 100px">
                                        <form  class="needs-validation">
                                            <button class="btn btn-block click-if-alone" type="button" disabled>
                                                <img width="150" style="margin-top: -10px"
                                                     src="{{asset('public/assets/front-end/img/cod.png')}}"/>
                                            </button>
                                        </form>
