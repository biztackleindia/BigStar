                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item mb-2 mt-2" onclick="anotherAddress()">
                                    ...
                                    <button type="button" class="btn btn-outline" data-toggle="collapse"
                                            data-target="#collapseThree">{{ \App\CPU\translate('new')}} {{ \App\CPU\translate('address')}}
                                    </button>
                                    <div id="accordion">
                                    <!-- {{$shipping_addresses->count()==0?'show':''}} -->
                                        <div id="collapseThree"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">{{ \App\CPU\translate('state')}}<span
                                                            style="color: red">*</span></label>
                                                    <input type="text" class="form-control"
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item mb-2 mt-2" onclick="billingAddress()">
                                        ...
                                        {{-- <label class="badge"
                                            ...
                                            <i class="fa fa-plus-circle"></i></label> --}}
                                        <button type="button" class="btn btn-outline" data-toggle="collapse"
                                                data-target="#billing_model">{{ \App\CPU\translate('new')}} {{ \App\CPU\translate('address')}}
                                        </button>
                                        <div id="accordion">
                                        <!-- {{$billing_addresses->count()==0?'show':''}} -->
                                            <div id="billing_model"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <label for="exampleInputEmail1">{{ \App\CPU\translate('state')}}<span
                                                            style="color: red">*</span></label>
                                                    <input type="text" class="form-control"
                                                           name="billing_state" {{$shipping_addresses->count()==0?'required':''}}>
                                                </div>
                                                    <div class="form-group">
                                                        <label
                                                            for="exampleInputEmail1">{{ \App\CPU\translate('address')}}<span
