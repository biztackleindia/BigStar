...
<div class="container rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
    <div class="row">
        ...
        <div class="col-md-9 sidebar_heading">
            <h1 class="h3 mt-3 mb-0 float-{{Session::get('direction') === "rtl" ? 'right' : 'left'}} headerTitle">
                {{\App\CPU\translate('return_request')}}
            </h1>
        </div>
    </div>
</div>
                                ...
                                <form action="{{route('refund-store')}}"  method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label class="input-label" for="name">{{\App\CPU\translate('return_reason')}}</label>
