...
@push('css_or_js')
    ...
    <style>
        ...
        @media(min-width:801px){
            ...
            .recomanded-product-card {
                background: #F8FBFD;margin:20px;height: auto; border-radius: 5px;padding-bottom: 1px;
            }
            .recomanded-buy-button {
                text-align: center;
                margin-top: 63px;
                        ...
                        <div class="recomanded-product-card">
                            ...
                            <div style="background:#ffffff;margin:20px;padding-top: 10px;height: 200px;border-radius: 0px 0px 5px 5px;">
                                <div style="text-align: left; padding: 20px;">
                                    ...
                                    <div class="rating-show" style="height:auto;text-align: center; ">
                    ...
                    @else
                        ...
                        @if(isset($product))
                            ...
                            <div class="recomanded-product-card">
                                ...
                                <div class="d-flex justify-content-center align-items-center" style="margin:20px 20px -20px 20px;padding-top: 20px;">
                                    <img style="    max-height: auto;"
                                        src="{{\App\CPU\ProductManager::product_image_path('thumbnail')}}/{{$product['thumbnail']}}"
                                        onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                        alt="">
                                </div>
                                <div style="background:#ffffff;margin:20px;padding-top: 10px;height: auto;border-radius: 0px 0px 5px 5px;">
                                    <div style="text-align: left; padding: 20px;">
                                        ...
                                        @if($product->member_discount > 0 && $product->member_discount != '')
                                        {{\App\CPU\Helpers::currency_converter(
                                                $product->unit_price-(\App\CPU\Helpers::get_member_product_discount($product,$product->unit_price))
                                            )}}
                                        @else
                                            {{\App\CPU\Helpers::currency_converter(
...
@php($main_section_banner = \App\Model\Banner::where('banner_type','Main Section Banner')->where('published',1)->orderBy('id','desc')->latest()->first())
                            ...
                            @foreach($bestSellProduct as $key=>$bestSell)
                                @if($bestSell->product && $key<3)
                                    ...
                                    border-color: #0000000d; border-radius:5px;"
                                         ...
                                         @if(auth('customer')->check())
                                         @if(auth('customer')->user()->member_id !='' && auth('customer')->user()->member_approval==1 )
                                        @if($bestSell->product->member_discount > 0 && $bestSell->product->member_discount != '')
                                        <div class="d-flex" style="left:5px;top:5px;position: absolute">
                                                    <span class="for-discoutn-value p-1 pl-2 pr-2">
                                                @if ($bestSell->product->member_discount_type == 'percent')
                                                    {{round($bestSell->product->member_discount)}}%
                                                @elseif($bestSell->product->member_discount_type =='flat')
                                                    {{\App\CPU\Helpers::currency_converter($bestSell->product->member_discount)}}
                                                @endif {{\App\CPU\translate('off')}}
                                            </span>
                                        </div>
                                        @elseif($bestSell->product->discount > 0)
                                        ...
                                        <div class="row" style="padding:8px;">
                                            ...
                                            <div class="best-selling-details" style="">
                                                ...
                                                <div class="widget-product-meta">
                                                    ...
                                                    @if($bestSell->product->member_discount > 0 && $bestSell->product->member_discount != '')
                                                    {{\App\CPU\Helpers::currency_converter(
                                                        $bestSell->product->unit_price-(\App\CPU\Helpers::get_member_product_discount($bestSell->product,$bestSell->product->unit_price))
                                                        )}}
                                                    @else
                                                        {{\App\CPU\Helpers::currency_converter(
                            ...
                            @foreach($topRated as $key=>$top)
                                @if($top->product && $key<3)
                                    ...
                                    border-color: #0000000d; border-radius:5px;"
                                         ...
                                         @if(auth('customer')->check())
                                         @if(auth('customer')->user()->member_id !='' && auth('customer')->user()->member_approval==1 )
                                        @if($top->product->member_discount > 0 && $top->product->member_discount != null)
                                        <div class="d-flex" style="left:5px;top:5px;position: absolute">
                                                    <span class="for-discoutn-value p-1 pl-2 pr-2">
                                                   
                                                @if ($top->product->member_discount_type == 'percent')
                                                    {{round($top->product->member_discount)}}%
                                                @elseif($top->product->member_discount_type =='flat')
                                                    {{\App\CPU\Helpers::currency_converter($top->product->member_discount)}}
                                                @endif {{\App\CPU\translate('off')}}
                                            </span>
                                        </div>
                                        @elseif($top->product->discount > 0)
                                                <div class="d-flex" style="top:0;position:absolute;{{Session::get('direction') === "rtl" ? 'right:0;' : 'left:0;'}}">
                                                    <span class="for-discoutn-value p-1 pl-2 pr-2" style="{{Session::get('direction') === "rtl" ? 'border-radius:0px 5px' : 'border-radius:5px 0px'}};">
                                        ...
                                        <div class="row" style="padding:8px;">
                                            ...
                                            <div class="top-rated-details" >
                                                ...
                                                <div>
                                                    ...
                                                    @if(auth('customer')->check())
                                            @if(auth('customer')->user()->member_id !='' && auth('customer')->user()->member_approval==1 )
                                            @if($top->product->member_discount > 0 && $top->product->member_discount != '')
                                            <strike style="font-size: 12px!important;color: #E96A6A!important;">
                                            ...
                                            @endif
                                                ...
                                                <div class="widget-product-meta">
                                                    ...
                                                    @if($top->product->member_discount > 0 && $top->product->member_discount != '')
                                                    {{\App\CPU\Helpers::currency_converter(
                                                        $top->product->unit_price-(\App\CPU\Helpers::get_member_product_discount($top->product,$top->product->unit_price))
                                                        )}}
                                                    @else
                                                        {{\App\CPU\Helpers::currency_converter(
    ...
    <div class="container rtl mb-3">
        <div class="row shipping-policy-web" style="margin-right: 0px; margin-left:0px;display: none;">
...
<script>
     ...
     console.log($('#featured_products_list'));
     var loop_boolean =false;
     if($('#featured_products_list').find('.owl-item.active').length >4){
        loop_boolean =true;
       }
       else{
        loop_boolean =false;
