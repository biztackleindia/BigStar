                        ...
                        <div class="form-group">
                            @foreach(json_decode($language) as $lang)
                                ...
                                <div class="row {{$lang != $default_lang ? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                    ...
                                    <div class="col-md-12">
                                        <label for="name">{{ \App\CPU\translate('Title')}} ({{strtoupper($lang)}}) <span class="input-label-secondary">*</span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label for="name">{{ \App\CPU\translate('end_date')}} <span class="input-label-secondary">*</span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12" style="padding-top: 20px">
                                    <center>
                                        ...
                                        onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'" src="{{asset('storage/app/public/deal')}}/{{$deal['banner']}}" alt="banner image"/>
                                    </center>
                                </div>
                            </div>
                        </div>
