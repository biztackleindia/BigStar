...
@section('content')
    <div class="content container-fluid">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="col-sm mb-2 mb-sm-0">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio custom-radio-reverse"
                                             onclick="currency_symbol_position('{{route('admin.web-config.currency-symbol-position',['left'])}}')">
                                ...
                                <div class="col-sm mb-2 mb-sm-0">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio custom-radio-reverse"
                                             onclick="currency_symbol_position('{{route('admin.web-config.currency-symbol-position',['right'])}}')">
                                            <input type="radio" class="custom-control-input"
                                                   name="projectViewNewProjectTypeRadio"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" style="padding: 20px">
                            ...
                            <form style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                                  action="{{route('admin.web-config.app-store-update',['download_app_apple_stroe'])}}"
                                  method="post">
                                @csrf
                                @if(isset($config))
                                    ...
                                    <div class="form-group mb-2">
                                        <label
                                            style="padding-{{Session::get('direction') === "rtl" ? 'right' : 'left'}}: 10px">{{\App\CPU\translate('link')}}<span class="input-label-secondary">*</span></label><br>
                ...
                <div class="col-12 col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body" style="padding: 20px">
                            ...
                            <form style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                                  action="{{route('admin.web-config.app-store-update',['download_app_google_stroe'])}}"
                                  method="post">
                                @csrf
                                @if(isset($config))
        ...
        <div
            ...
            <form action="{{ route('admin.web-config.update-info') }}" method="POST"
                ...
                <div class="row" style="padding-bottom: 20px">
                    ...
                    @php($tm=\App\CPU\Helpers::get_business_settings('transport_mode'))
                    <div class="col-md-6">
                        <div class="form-group">
                            <label
                                class="input-label d-inline text-capitalize">{{\App\CPU\translate('transport_mode')}} </label>
                            <select name="transport_mode" class="form-control  js-select2-custom">
                             
                                <option value="express" {{ isset($tm)?($tm=='express'?'selected':''):'' }} >Express</option>
                                <option value="surface" {{ isset($tm)?($tm=='surface'?'selected':''):'' }}>Surface</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-12">
                        ...
                        <div class="form-group">
                            <label>{{\App\CPU\translate('member')}} {{\App\CPU\translate('settings')}}</label><small
                                style="color: red">*</small>
                            <div class="input-group input-group-md-down-break">
                                <!-- Custom Radio -->
                                <div class="form-control">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" value="1"
                                               ...
                                               id="member_settings1" {{$member_settings==1?'checked':''}}>
                                        <label class="custom-control-label"
                                               for="member_settings1">{{\App\CPU\translate('on')}}</label>
                                    </div>
                                </div>
                                <!-- End Custom Radio -->
                                ...
                                <div class="form-control">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" value="0"
                                               name="member_settings"
                                               id="member_settings2" {{$member_settings==0?'checked':''}}>
                                        <label class="custom-control-label"
                                               for="member_settings2">{{\App\CPU\translate('off')}}</label>
                                    </div>
                                </div>
                                <!-- End Custom Radio -->
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <span class="badge badge-soft-danger">( {{ \App\CPU\translate('size')}} 200 x 200)</span>
                            </div>
                            <div class="card-body" style="padding: 20px;height:180px;">
                                <center>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <span class="badge badge-soft-danger">( {{ \App\CPU\translate('size')}} 500 x 500  )</span>
                            </div>
                            <div class="card-body" style="padding: 20px;height:180px;">
                                <center>
