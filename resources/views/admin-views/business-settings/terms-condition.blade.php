        ...
        <div class="row" style="margin-top: 20px">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form action="{{route('admin.web-config.update-terms')}}" method="post">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                <div class="col-md-12">
                                    <label for="editor">{{\App\CPU\translate('terms_and_condition')}}<span class="input-label-secondary">*</span></label>
