                ...
                <div class="card-body">
                    <form action="{{route('admin.coupon.update',[$c['id']])}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="name">{{\App\CPU\translate('Title')}} <span class="input-label-secondary">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-3 col-6">
                                <div class="form-group">
                                    <label for="name">{{\App\CPU\translate('start_date')}} <span class="input-label-secondary">*</span></label>
                            ...
                            <div class="col-md-3 col-6">
                                <div class="form-group">
                                    <label for="name">{{\App\CPU\translate('expire_date')}} <span class="input-label-secondary">*</span></label>
                            ...
                            <div class="col-md-3 col-6">
                                <div class="form-group">
                                    <label  for="exampleFormControlInput1">{{\App\CPU\translate('limit')}} {{\App\CPU\translate('for')}} {{\App\CPU\translate('same')}} {{\App\CPU\translate('user')}} <span class="input-label-secondary">*</span></label>
                            ...
                            <div class="col-md-3 col-6">
                                <div class="form-group">
                                    <label  for="name">{{\App\CPU\translate('discount_type')}} <span class="input-label-secondary">*</span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-6">
                                <label for="name">{{\App\CPU\translate('minimum_purchase')}} <span class="input-label-secondary">*</span></label>
