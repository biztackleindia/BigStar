                        ...
                        <form action="{{route('admin.coupon.store-coupon')}}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-6">
                                    <div class="form-group">
                                        <label
                                            for="exampleFormControlInput1">{{\App\CPU\translate('limit')}} {{\App\CPU\translate('for')}} {{\App\CPU\translate('same')}} {{\App\CPU\translate('user')}} <span class="input-label-secondary">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-3 col-6">
                                    <div class="form-group">
                                        <label for="name">{{\App\CPU\translate('Discount')}} <span class="input-label-secondary">*</span></label>
