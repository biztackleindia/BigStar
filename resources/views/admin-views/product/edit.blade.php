                                ...
                                <div class="{{$lang != 'en'? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                    <div class="form-group">
                                        <label class="input-label" for="{{$lang}}_name">{{\App\CPU\translate('name')}}
                                            ({{strtoupper($lang)}}) <span class="input-label-secondary">{{$lang == $default_lang? '*':''}}</span></label>
                    ...
                    <div class="card mt-2 rest-part">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        <label for="name">{{\App\CPU\translate('Category')}} <span class="input-label-secondary">*</span></label>
                                        <select
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4" id="unit_weight">
                                     <label class="control-label">{{\App\CPU\translate('weight')}}</label>
                                        <input type="number" min="0"  value="{{ $product->unit_weight }}" step="0.01"
                                               placeholder="{{\App\CPU\translate('weight')}}" name="unit_weight"
                                               class="form-control" >
                                    </div>
                                    <br>
                                    <div class="col-md-4 mt-3" id="product_sku">
                                     <label class="control-label">{{\App\CPU\translate('product_sku')}}</label>
                                        <input type="text"   value="{{ $product->product_sku }}" 
                                               placeholder="{{\App\CPU\translate('product_sku')}}" name="product_sku"
                                               class="form-control" >
                                    </div>
                                   
                                    <div class="col-md-4  mt-3" id="product_reward_point">
                                     <label class="control-label">{{\App\CPU\translate('Reward point')}}</label>
                                        <input type="text"   value="{{$product->product_reward_point}}" 
                                               placeholder="{{\App\CPU\translate('Reward point')}}" name="product_reward_point"
                                               class="form-control" >
                                    </div>
                    ...
                    <div class="card mt-2 rest-part">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-3">
                                        <label class="control-label">{{\App\CPU\translate('Unit price')}} <span class="input-label-secondary">*</span></label>
                                    ...
                                    <div class="col-md-3">
                                        <label
                                            class="control-label">{{\App\CPU\translate('Purchase price')}} <span class="input-label-secondary">*</span></label>
                                        <input type="number" min="0" step="0.01"
                                    ...
                                    <div class="col-md-3">
                                        <label class="control-label">{{\App\CPU\translate('member_discount')}}</label>
                                        <input type="number" min="0"  step="0.01"
                                               placeholder="{{\App\CPU\translate('member_discount')}}" name="member_discount"
                                               class="form-control" value={{ \App\CPU\Convert::default($product->member_discount) }}>
                                    </div>
                                    <div class="col-md-3" >
                                    <label class="control-label">{{\App\CPU\translate('member_discount_type')}}</label>
                                        <select
                                            style="width: 100%"
                                            class="js-example-basic-multiple js-states js-example-responsive demo-select2"
                                            name="member_discount_type">
                                            <option
                                                value="percent" {{$product['member_discount_type']=='percent'?'selected':''}}>{{\App\CPU\translate('Percent')}}</option>
                                            <option
                                                value="flat" {{$product['member_discount_type']=='flat'?'selected':''}}>{{\App\CPU\translate('Flat')}}</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{\App\CPU\translate('Upload product images')}}</label><small
                                            style="color: red">* ( {{ \App\CPU\translate('size')}} 500 x 500 )</small>
                                    </div>
