                ...
                <div class="card-body">
                    <form action="{{route('admin.employee.update',[$e['id']])}}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="name">{{\App\CPU\translate('Name')}}<span class="input-label-secondary">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <label for="name">{{\App\CPU\translate('Phone')}}<span class="input-label-secondary">*</span></label>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="name">{{\App\CPU\translate('Email')}}<span class="input-label-secondary">*</span></label>
                                    <input type="email" value="{{$e['email']}}" name="email" class="form-control" id="email"
                                           placeholder="{{\App\CPU\translate('Ex')}} : ex@gmail.com" pattern="[a-zA-Z0-9._%+\-]+@[a-zA-Z0-9.\-]+\.[a-z]{2,}$" required>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="name">{{\App\CPU\translate('Password')}}<span class="input-label-secondary">*</span></label><small> ( {{\App\CPU\translate('input if you want to change')}} )</small>
