<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    ...
    <a class="card card-hover-shadow h-100" href="{{route('admin.orders.list',['pending'])}}" style="background: #FFFFFF">
        <div class="card-body" style="background: #a0c63aed;
    border-radius: 8px;">
            <div class="flex-between align-items-center mb-1">
                <div style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                    <h6 class="card-subtitle" style="color: #fff!important;">{{\App\CPU\translate('pending')}}</h6>
                    <span class="card-title h2" style="color: #fff!important;">
                        {{$data['pending']}}
                    </span>
                </div>
                <div class="mt-2">
                    <i class="tio-shopping-cart" style="font-size: 30px;color: #fff;"></i>
                </div>
            </div>
            <!-- End Row -->
        </div>
...
<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    ...
    <a class="card card-hover-shadow h-100" href="{{route('admin.orders.list',['confirmed'])}}" style="background: #FFFFFF;">
        <div class="card-body" style="background: #9c237a;
    border-radius: 8px;">
            <div class="flex-between align-items-center mb-1">
                <div style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                    <h6 class="card-subtitle" style="color: #fff!important;">{{\App\CPU\translate('confirmed')}}</h6>
                     <span class="card-title h2" style="color: #fff!important;">
                         {{$data['confirmed']}}
                     </span>
                </div>
                ...
                <div class="mt-2">
                    <i class="tio-checkmark-circle" style="font-size: 30px;color: #fff"></i>
                </div>
            </div>
            <!-- End Row -->
        </div>
...
<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    ...
    <a class="card card-hover-shadow h-100" href="{{route('admin.orders.list',['processing'])}}" style="background: #FFFFFF">
        <div class="card-body " style="    background: #041562;
    border-radius: 8px;">
            <div class="flex-between align-items-center gx-2 mb-1">
                <div style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                    <h6 class="card-subtitle" style="color: #fff!important;">{{\App\CPU\translate('Processing')}}</h6>
                    <span class="card-title h2" style="color: #fff!important;">
                        {{$data['processing']}}
                    </span>
                </div>
                ...
                <div class="mt-2">
                    <i class="tio-time" style="font-size: 30px;color: #fff"></i>
                </div>
            </div>
            <!-- End Row -->
        </div>
...
<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    ...
    <a class="card card-hover-shadow h-100" href="{{route('admin.orders.list',['out_for_delivery'])}}" style="background: #FFFFFFff">
        <div class="card-body" style="background: #3fa3db;
    border-radius: 8px;">
            <div class="flex-between align-items-center gx-2 mb-1">
                <div style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                    <h6 class="card-subtitle" style="color: #fff!important;">{{\App\CPU\translate('out_for_delivery')}}</h6>
                    <span class="card-title h2" style="color: #fff!important;">
                ...
                <div class="mt-2">
                    <i class="tio-bike" style="font-size: 30px;color: #fff"></i>
                </div>
            </div>
            <!-- End Row -->
        </div>
