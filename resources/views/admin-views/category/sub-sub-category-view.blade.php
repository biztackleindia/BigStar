                        ...
                        <form action="{{route('admin.sub-sub-category.store')}}" method="POST">
                            ...
                            @if($language)
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <label
                                            for="name">{{\App\CPU\translate('sub_category')}} {{\App\CPU\translate('name')}} <span class="input-label-secondary">*</span><span class="input-label-secondary">{{$lang == $default_lang? '*':''}}</span></label>
