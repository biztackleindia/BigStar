                    ...
                    <div class="card-body">
                        <form id="submit-create-role" action="{{route('admin.custom-role.update',[$role['id']])}}" method="post"
                            ...
                            <div class="form-group">
                                <label for="name">{{\App\CPU\translate('role_name')}}<span class="input-label-secondary">*</span></label>
                            ...
                            <label for="module">{{\App\CPU\translate('module_permission')}}<span class="input-label-secondary">*</span> : </label>
                            <hr>
                            <div class="row">
                                <div class="col-md-3">
