...
<div id="sidebarMain" class="d-none">
    <aside
        style="    background: #041562!important; text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                ...
                <div class="navbar-vertical-content mt-2">
                    ...
                    <!--business section ends here-->
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('user_section'))
                            ...
                            <li class="nav-item {{Request::is('admin/member/list')?'active':''}}">
                                <a class="nav-link " href="{{route('admin.member.list')}}">
                                    <span class="tio-users-switch nav-icon"></span>
                                    <span
                                        class="text-truncate">{{\App\CPU\translate('member')}} </span>
                                </a>
                            </li>
                    ...
                    @if(\App\CPU\Helpers::module_permission_check('web_&_app_settings'))
                            <li class="nav-item {{(Request::is('admin/business-settings/social-media') || Request::is('admin/web-config/terms-condition') || Request::is('admin/web-config/refund-index') || Request::is('admin/business-settings/privacy-policy') || Request::is('admin/business-settings/about-us') || Request::is('admin/helpTopic/list') || Request::is('admin/business-settings/fcm-index') || Request::is('admin/business-settings/mail')|| Request::is('admin/web-config/db-index') || Request::is('admin/web-config'))?'scroll-here':''}}">
                                <small class="nav-subtitle"
                                       title="">{{\App\CPU\translate('web_&_app_settings')}}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>

                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/web-config')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.web-config.index')}}">
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/web-config/refund-index')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.web-config.refund-index')}}">
                                    <i class="tio-money nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/web-config/captcha')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.web-config.captcha')}}">
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/web-config/analytics-index')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.web-config.analytics-index')}}">
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/web-config/mail')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.web-config.mail.index')}}">
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/web-config/terms-condition') || Request::is('admin/business-settings/privacy-policy') || Request::is('admin/business-settings/about-us') || Request::is('admin/helpTopic/list')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{Request::is('admin/web-config/terms-condition') || Request::is('admin/business-settings/privacy-policy') || Request::is('admin/business-settings/about-us') || Request::is('admin/helpTopic/list')?'block':'none'}}">
                                    <li class="nav-item {{Request::is('admin/web-config/terms-condition')?'active':''}}">
                                        <a class="nav-link" href="{{route('admin.web-config.terms-condition')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                    ...
                                    <li class="nav-item {{Request::is('admin/web-config/privacy-policy')?'active':''}}">
                                        <a class="nav-link" href="{{route('admin.web-config.privacy-policy')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                    ...
                                    <li class="nav-item {{Request::is('admin/web-config/about-us')?'active':''}}">
                                        <a class="nav-link" href="{{route('admin.web-config.about-us')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/web-config/social-media')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.web-config.social-media')}}">
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/web-config/map-api*')?'active':''}}">
                                <a class="nav-link " href="{{route('admin.web-config.map-api')}}"
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('business_settings'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/points/view')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.points.view')}}">
                    ...
                    <!--web & app settings ends here-->
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('report'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/report/order-detail')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.report.order-detail')}}">
                                    <i class="tio-chart-line-up nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                       {{\App\CPU\translate('Order')}} {{\App\CPU\translate('detail_report')}}
                                    </span>
                                </a>
                            </li>
                    ...
                    @if(\App\CPU\Helpers::module_permission_check('pincode_management'))
                        <li class="nav-item {{(Request::is('admin/pincode*') || Request::is('admin/pincode-role*'))?'scroll-here':''}}">
                                <small class="nav-subtitle">{{\App\CPU\translate('pincode_management')}}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/pincode-role*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.pincode-role.create')}}">
                                    <i class="tio-map nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                            {{\App\CPU\translate('pincode')}}</span>
                                </a>
                            </li>
                        @endif
