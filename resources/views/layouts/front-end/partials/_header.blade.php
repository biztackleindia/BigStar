...
<header class="box-shadow-sm rtl">
        ...
        <div class="navbar navbar-expand-md navbar-light">
            <div class="container ">
                ...
                <a class="navbar-brand d-none d-sm-block {{Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'}} flex-shrink-0"
                    ...
                    <img style="max-width: 200px;max-height: 70px!important;"
    ...
    @if(auth('customer')->check())
    @if(auth('customer')->user()->member_id !='' && auth('customer')->user()->member_approval==0 && auth('customer')->user()->member_approval_status==0)
    <div class="toast align-items-center cust-toast bg-info" role="alert" aria-live="assertive" aria-atomic="true" >
        <div class="d-flex">
            <div class="toast-body">
           Your Member request is under processing
        </div>
            <button type="button" class="btn-close me-2 m-auto" onclick="closetoast()" data-bs-dismiss="toast" aria-label="Close">x</button>
        </div>
        </div>

    @endif
    @if(auth('customer')->user()->member_id !='' && auth('customer')->user()->member_approval==1 && auth('customer')->user()->member_approval_status==0)
    <div class="toast align-items-center cust-toast" role="alert" aria-live="assertive" aria-atomic="true" >
        <div class="d-flex">
            <div class="toast-body">
           Your Member request has been approved
        </div>
            <button type="button" class="btn-close me-2 m-auto" onclick="closetoast()" data-bs-dismiss="toast" aria-label="Close">x</button>
        </div>
        </div>
    ...
    @endif
    @if(auth('customer')->user()->member_id !='' && auth('customer')->user()->member_approval==2 && auth('customer')->user()->member_approval_status==0)
    <div class="toast align-items-center cust-toast bg-error" role="alert" aria-live="assertive" aria-atomic="true" >
        <div class="d-flex">
            <div class="toast-body">
           Your member request has been rejected
        </div>
            <button type="button" class="btn-close me-2 m-auto" onclick="closetoast()" data-bs-dismiss="toast" aria-label="Close">x</button>
        </div>
        </div>
