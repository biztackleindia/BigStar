...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'points', 'as' => 'points.','middleware'=>['module:business_settings']], function () {
            Route::get('view', 'BusinessSettingsController@pointsindex')->name('view');
            Route::post('store', 'BusinessSettingsController@PointsStore')->name('store');
        });
        ...
        Route::group(['prefix' => 'customer', 'as' => 'customer.','middleware'=>['module:user_section']], function () {
            ...
            Route::post('approve-status', 'CustomerController@ApproveStatus_update')->name('approve-status');
            Route::post('reject-status', 'CustomerController@RejectStatus_update')->name('reject-status');
        });
        Route::group(['prefix' => 'member', 'as' => 'member.','middleware'=>['module:user_section']], function () {
            Route::get('list', 'CustomerController@member_list')->name('list');
        });
        Route::post('order_type', 'ReportController@OrderTypeSet')->name('order_type');
        Route::post('pick_up_update', 'ReportController@PickupUpdate')->name('pick_up_update');
        ///Report
        Route::group(['prefix' => 'report', 'as' => 'report.' ,'middleware'=>['module:report']], function () {
            ...
            Route::get('order-detail', 'ReportController@order_detail_index')->name('order-detail');
            Route::get('pdfview',array('as'=>'pdfview','uses'=>'ReportController@order_detail_index'));
           
            Route::get('delivery_format_view', 'ReportController@DeliveryFormat_index')->name('delivery_format_view');
            Route::get('export_excel',array('as'=>'export_excel','uses'=>'ReportController@DeliveryFormat_index'));
            //sale report inhouse
...
// export
        Route::get('export_report', 'ReportController@orderReportExport')->name('export_report');
        Route::any('export_sale_report', 'ReportController@ProductSaleReportExport')->name('export_sale_report');
        Route::group(['prefix' => 'pincode-role', 'as' => 'pincode-role.','middleware'=>['module:pincode_management']], function () {
            Route::get('create', 'CustomRoleController@createPincode')->name('create');
            Route::post('create', 'CustomRoleController@storePincode')->name('store');
            Route::get('update/{id}', 'CustomRoleController@Pincodeedit')->name('edit');
            Route::post('update/{id}', 'CustomRoleController@updatePincode')->name('edit');
            Route::get('delete/{id}', 'CustomRoleController@DeletePincode')->name('delete');
            Route::post('cash-on-delivery', 'CustomRoleController@CashonDelivery_status')->name('cash-on-delivery');
            Route::post('online-delivery', 'CustomRoleController@OnlineDelivery_status')->name('online-delivery');
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.','middleware'=>['module:order_management']], function () {
            ...
            Route::post('bulkstatus', 'OrderController@bulkOrderStatusChange')->name('bulkstatus');
